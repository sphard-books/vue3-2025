...
const config: Config = {
  ...
  projectName: "vue3-2025", // Usually your repo name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/sphard-books/vue3-2025/edit/main",
        },
        // blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/sphard-books/vue3-2025",
          label: "GitHub",
          position: "right",
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Vue3教程(2025), Inc. Built with Docusaurus.`,
    },
    prism: {
